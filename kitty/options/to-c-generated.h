...
static void
convert_from_python_software_mouse_cursor(PyObject *val, Options *opts) {
    opts->software_mouse_cursor = PyLong_AsLong(val);
}

static void
convert_from_opts_software_mouse_cursor(PyObject *py_opts, Options *opts) {
    PyObject *ret = PyObject_GetAttrString(py_opts, "software_mouse_cursor");
    if (ret == NULL) return;
    convert_from_python_software_mouse_cursor(ret, opts);
    Py_DECREF(ret);
}
...
convert_opts_from_python_opts(PyObject *py_opts, Options *opts) {
    ...
    if (PyErr_Occurred()) return false;
    convert_from_opts_software_mouse_cursor(py_opts, opts);
    if (PyErr_Occurred()) return false;
