...
def conf_parsing(self):
    ...
    opts = p('software_mouse_cursor pointer', 'tab_bar_show_new_tab_button yes')
    self.ae(opts.software_mouse_cursor, 2)
    self.assertTrue(opts.tab_bar_show_new_tab_button)
